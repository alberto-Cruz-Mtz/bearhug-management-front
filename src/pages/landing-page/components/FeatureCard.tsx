...
export default function FeatureCard({ icon, title, description, color }: CardProps) {
  return (
    <article className={`w-4/5 mx-auto border-3 space-y-1 border-gray-300 hover:border-${color} px-4 py-8 rounded-lg shadow-[-15px_21px_14px_-1px_rgba(0,_0,_0,_0.2)]`}>
